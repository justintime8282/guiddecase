...
**Reflected (structural, not just a relabel):** restructured the dashboard cut from "Revenue by Motion (PLG vs Inbound vs Outbound)" to **"Channel Performance"** — the chart now shows **PQLs generated by acquisition channel** (Self-serve / Inbound / Outbound / Referral), with won $ and win rate per channel. PLG is treated as the overarching motion, not a category competing with channels. Plus a framing/feasibility note and updated four-questions language.
